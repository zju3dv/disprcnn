...
from disprcnn.utils.comm import synchronize
...
def cache_url(url, model_dir=None, progress=True):
    ...
    Example:
        >>> cached_file = disprcnn.utils.model_zoo.cache_url('https://s3.amazonaws.com/pytorch/models/resnet18-5c106cde.pth')
    """
