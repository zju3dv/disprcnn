...
class KITTIObjectDatasetCar(torch.utils.data.Dataset):
    CLASSES = (
        "__background__",
        "car",
        'dontcare'
    ...
    def __init__(self, root, split, transforms=None, filter_empty=False, offline_2d_predictions_path='',
                 shape_prior_base='vob', remove_ignore=True):
        """
        :param root: '.../kitti/
        ...
        self.root = root
        self.split = split
        cls = KITTIObjectDatasetCar.CLASSES
    ...
    def map_class_id_to_class_name(self, class_id):
        return KITTIObjectDatasetCar.CLASSES[class_id]
