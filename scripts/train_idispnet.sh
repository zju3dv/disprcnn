...
# split predictions
python tools/split_predictions.py --prediction_path models/kitti/pob/mask/inference/kitti_%s_pob/predictions.pth --split_path ~/Datasets/kitti/object/split_set/%s_set.txt
# generate rois
