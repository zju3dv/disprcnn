...
python tools/split_predictions.py --prediction_path models/kitti/pob/idispnet/inference/kitti_%s_pob/predictions.pth --split_path ~/Datasets/kitti/object/split_set/%s_set.txt
# train RPN
echo 'train RPN...'
